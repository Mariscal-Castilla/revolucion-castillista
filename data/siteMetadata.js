...
const siteMetadata = {
  ...
  description: 'Un espacio informativo para mantener a la comunidad al tanto de los acontecimientos en el Colegio Mariscal Castilla.',
  language: 'es-ES',
  theme: 'system',
  ...
  mastodon: '', 
  email: 'contacto@rc.zioo.space', 
  github: 'https://github.com/tuusuario',
  x: 'https://twitter.com/tuusuario', 
